...
const formationDispo = React.lazy(() => import('./views/NosFormations/formations'))
const listeFormation = React.lazy(() => import('./views/GestionFormation/listeFormation'))
const Info = React.lazy(() => import('./views/NosFormations/formationInfo'))
//Cours
...
const routes = [
  ...
  {
    path: '/NosFormations/formations',
    name: 'Nos formations',
    element: formationDispo,
  },
  {
    path: '/NosFormations/formations/formationInfo',
    name: 'Info',
    element: Info,
  },
  {
